...
const defaultSceneEffects: SceneEffects = { starfield: true, parallax: true, twinkle: true, trails: true };

function savedSceneEffects(): SceneEffects {
  try {
    const value = JSON.parse(localStorage.getItem(sceneEffectsStorageKey) ?? "");
    return { starfield: value.starfield !== false, parallax: value.parallax !== false, twinkle: value.twinkle !== false, trails: value.trails !== false };
...
const sceneEffectOptions:{key:keyof SceneEffects;label:string;detail:string}[]=[
