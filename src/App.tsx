...
const defaultSceneEffects: SceneEffects = { starfield: true, parallax: true, twinkle: true, trails: true, speed: 1 };
...
function savedSceneEffects(): SceneEffects {
  try {
    ...
    return {
      ...
      speed: Number.isFinite(speed) && speed >= 0.25 && speed <= 2 ? speed : defaultSceneEffects.speed,
    };
